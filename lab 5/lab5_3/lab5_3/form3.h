...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(22, 17);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(314, 135);
			...
			this->dataGridView2->Location = System::Drawing::Point(22, 268);
			this->dataGridView2->Name = L"dataGridView2";
			this->dataGridView2->RowHeadersWidth = 51;
			this->dataGridView2->RowTemplate->Height = 24;
			this->dataGridView2->Size = System::Drawing::Size(314, 135);
			this->dataGridView2->TabIndex = 1;
			// 
			// button1
			// 
			this->button1->BackColor = System::Drawing::Color::LemonChiffon;
			this->button1->Font = (gcnew System::Drawing::Font(L"Papyrus", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->ForeColor = System::Drawing::SystemColors::ControlText;
			this->button1->Location = System::Drawing::Point(25, 163);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(179, 66);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(645, 736);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(179, 66);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Papyrus", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(22, 419);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(179, 66);
			this->button3->TabIndex = 4;
			this->button3->Text = L"Process matrix";
			...
			this->ClientSize = System::Drawing::Size(490, 541);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		for (int i = 0; i < 5; i++)
		{
			...
			{
				K[i][j] = rand() % 100 - 50;
				dataGridView1->Rows[i]->Cells[j]->Value = Convert::ToString(K[i][j]);
			}
		}
	}
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		if (Convert::ToString(dataGridView1->Rows[0]->Cells[0]->Value) != "")
		{
			...
			for (int i = 0; i < 5; i++)
			{
				...
				for (int j = 0; j < 5; j++)
				{
					if (tmp_arr[i][j] > max) { max = tmp_arr[i][j]; maxi = i; maxj = j; }
				}
				swap(tmp_arr[i][0], tmp_arr[maxi][maxj]);
			}
			...
			for (int i = 0; i < 5; i++)
			{
				...
				{
					K[i][j] = tmp_arr[i][j];
					dataGridView2->Rows[i]->Cells[j]->Value = Convert::ToString(K[i][j]);
				}
			}
		}
		else
