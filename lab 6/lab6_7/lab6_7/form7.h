...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Size = System::Drawing::Size(726, 52);
			...
			this->el11->Name = L"p10";
			this->el11->Width = 30;
			// 
			// el12
			// 
			this->el12->MinimumWidth = 6;
			this->el12->Name = L"p11";
			this->el12->Width = 30;
			// 
			// el13
			// 
			this->el13->MinimumWidth = 6;
			this->el13->Name = L"p12";
			this->el13->Width = 30;
			// 
			// el14
			// 
			this->el14->MinimumWidth = 6;
			this->el14->Name = L"p13";
			this->el14->Width = 30;
			// 
			// button1
			// 
			this->button1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"button1.BackgroundImage")));
			this->button1->Font = (gcnew System::Drawing::Font(L"Elephant", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->ForeColor = System::Drawing::Color::Black;
			this->button1->Location = System::Drawing::Point(32, 91);
			...
			this->button2->Location = System::Drawing::Point(32, 183);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(157, 66);
			...
			this->label1->Location = System::Drawing::Point(28, 314);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(397, 25);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Sum of even elements on odd positions:";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(464, 314);
			...
			this->ClientSize = System::Drawing::Size(750, 413);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Convert::ToString(dataGridView1->Rows[0]->Cells[0]->Value) != "")
		{
			...
			for (int i = 0; i < 14; i++)
			{
				int elmt = Convert::ToInt32(dataGridView1->Rows[0]->Cells[i]->Value);
				A[i] = elmt;
				if ((elmt % 2 == 0) && (i % 2 != 0)) { sum += elmt; }
			}
